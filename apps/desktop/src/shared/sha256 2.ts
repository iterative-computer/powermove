/*
 * SHA-256 in plain JavaScript. `crypto.subtle` only exists in secure contexts,
 * and the served app is reached over plain http on a LAN or tailnet address.
 * Produces the same hex digest as SubtleCrypto so fingerprints match across
 * the desktop app and a browser.
 */
