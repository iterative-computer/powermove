...
Project files embed imported media and currently have a **256 MB total size limit**. A missing original or an oversized project is reported as an error; it is not saved as a broken or incomplete file. Generated effects and panels still need their corresponding extensions installed on another computer.
