...
export const MeDto = z.object({ user: z.object({ id: Uuid, name: z.string().nullable(), email: z.email(), image: z.string().nullable() }), publisher: PublisherDto.nullable(), settings: z.object({ rememberInstalls: z.boolean() }) });
