...
const res: Record<string, unknown> = {
  ...
  'Installs.List': { items: [install] }, 'Installs.Add': undefined, 'Installs.Delete': undefined, 'Publish.PutRelease': { repo: listing, release }, 'Publish.Yank': { repo: listing, release }, 'Publish.PatchRepo': listing, 'Publish.DeleteRepo': undefined, 'Admin.Moderate': listing, 'Admin.SeedPublisher': { publisher }
};
